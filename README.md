...
11. Gemini에 타임스탬프 자막만 전달해 45분 구간별 `계속/새 주제/복귀` 경계를 판정하고, 직접 인용은 로컬 자막과 다시 대조한 뒤 전체 방송의 처음·중간·후반 흐름을 종합한 한 줄 요약과 최종 타임라인 생성
...
21. 스트리머별 고유명사 단어 사전, 영상 목록을 유지하는 작업 기록 초기화, 캐시 보관 기간·영상별/전체 자막 삭제, 첫 실행 데이터 처리 안내
